...
const CaptainLogin = () => {
    ...
    // const {captain, setCaptain} = useContext(CaptainDataContext); // But to use this import useContext from 'react
    ...
    return (
        <div className='p-7 flex flex-col justify-between h-screen'>
            ...
            <div>
                <Link
                    to = '/login'
                    className='bg-[#FFB663] flex items-center justify-center text-white font-semibold mb-5 rounded px-4 py-2 border-gray-400 border w-full text-lg placeholder:text-base'
